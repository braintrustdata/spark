...
During setup, Braintrust Setup discovers installed local coding tools and can run Claude Code or Codex non-interactively using the user's existing subscription or token.
